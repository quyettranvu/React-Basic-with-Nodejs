               ...
               <form action="/" method="POST">
                   <table className="main-content">
                       <thead>
                           <tr>
                               <th>ID
                                    <FontAwesomeIcon icon={faSortUp} className="icon-additional"/>
                                    <FontAwesomeIcon icon={faSortDown} className="icon-second-additional"/>
                                </th>
                               <th>First Name
                                    <FontAwesomeIcon icon={faSortUp} className="icon-additional"/>
                                    <FontAwesomeIcon icon={faSortDown} className="icon-second-additional"/>
                       ...
                       <tbody>
                               {
                                    <tr >
                                        ...
                                        <td>{user.email}</td>
                                        <td>
                                            <button type="button" className="click-update" onClick={()=>navigate(`/update/${user._id}`)}>Edit</button>
                                        </td>
                                    </tr>
                               }
                       </tbody>
